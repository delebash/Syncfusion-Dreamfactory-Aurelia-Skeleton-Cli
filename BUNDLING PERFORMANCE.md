...
comment out
    ...
    <script src="syncfusion/scripts/jquery.js"></script>
    <script src="syncfusion/scripts/jquery.easing.1.3.js"></script>
    <script src="syncfusion/scripts/jsrender.min.js"></script>
    <script src="syncfusion/scripts/ej.widget.all.min.js"></script>
